...
class GatewayServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.ProcessBank = channel.unary_unary(
                '/GatewayService/ProcessBank',
                request_serializer=bank__pb2.Transaction.SerializeToString,
                response_deserializer=gateway__pb2.PaymentResponse.FromString,
                _registered_method=True)
        self.GetBalance = channel.unary_unary(
                '/GatewayService/GetBalance',
                request_serializer=bank__pb2.Account.SerializeToString,
                response_deserializer=bank__pb2.BalanceResponse.FromString,
                _registered_method=True)
        self.RegisterAccount = channel.unary_unary(
                '/GatewayService/RegisterAccount',
...
def add_GatewayServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessBank': grpc.unary_unary_rpc_method_handler(
                    servicer.ProcessBank,
                    request_deserializer=bank__pb2.Transaction.FromString,
                    response_serializer=gateway__pb2.PaymentResponse.SerializeToString,
            ),
            'GetBalance': grpc.unary_unary_rpc_method_handler(
                    servicer.GetBalance,
                    request_deserializer=bank__pb2.Account.FromString,
...
class GatewayService(object):
    ...
    def ProcessBank(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/GatewayService/ProcessBank',
            bank__pb2.Transaction.SerializeToString,
            gateway__pb2.PaymentResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetBalance(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/GatewayService/GetBalance',
            bank__pb2.Account.SerializeToString,
